 ...
 <head>
     ...
     <!-- This style for for comment scrool  -->
     <style>
     /* ennroll btn status */
     /* BASE BUTTON STYLE */
     .enroll-btn {
 ...
 <body>
     ...
     ORDER BY c.created_at DESC",
                ...
                if ($count > 0):
                    while (_fetch($stmt)): ?>
             <?php
                        $is_new = in_array($id, $newCourseIds);
                        ?>
             ...
             <div class="course-card">
                 ...
                 <div class="course-content">
                     ...
                     <div class="meta-actions">
                         ...
                         <!-- FEVO WITH ACTION -->
                         <a href="javascript:void(0)" class="icon-btn fav-btn <?= $is_fav ? 'active' : '' ?>"
                             data-id="<?= (int)$id ?>">
                         ...
                         <form method="POST" action="<?= url('user/enroll_cancel') ?>">
                             <input type="hidden" name="course_id" value="<?= $id ?>">
                             <button type="submit" class="enroll-btn cancel">
                                 Cancel
                             </button>
                         </form>
                         ...
                         <button class="enroll-btn approved">
                             Approved
                         </button>

                         <?php elseif ($enroll_status === 'rejected'): ?>
     ...
     <!-- search  end-->
     <!-- CTA SECTION -->
     <section class="cta-section"> <a href="<?= url('/user/home_user_ui') ?>" class="cta-button">View All Courses</a>
     </section>
     <?php require ROOT . '../pages/footer.php'; ?>

     <!-- for entroll btn controll script -->
